...
?>
		...
		<frameset rows="*,150" framespacing="0" frameborder="no" border="0">
			...
			<frame src="http://subtracts.userplane.com/mmm/bannerstorage/ch_int_frameset.html?app=ul&zoneID=<?php echo( $strZoneIDBanner ); ?>&textZoneID=<?php echo( $strZoneIDText ); ?>&domainid=<?php echo( $strDomainID ); ?>" name="Ad_Frame" scrolling="NO" noresize>
